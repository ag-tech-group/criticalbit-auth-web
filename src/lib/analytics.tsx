...
// All events from this site are prefixed so they can be filtered out of
// the shared "criticalbit" PostHog project without relying only on $host.
const EVENT_PREFIX = "auth_"
